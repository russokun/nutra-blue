# Las categorias tienen que ser las mismas que usa la planilla en produccion
# (Energía / Concentración y Calma / Descanso y Longevidad / Alimentación Diaria).
# Antes decian "Salud Cognitiva", "Longevidad" y "Gestión del Estrés": esas eran las
# viejas, y contra ellas si matcheaba la derivacion de etiquetas del carrusel del home.
# Por eso el bug ("la misma etiqueta en todos los productos") nunca se veia en local
# y si en produccion.
MOCK_PRODUCTS = [
    {
        "id": "calm-and-focus",
